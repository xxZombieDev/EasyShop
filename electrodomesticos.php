...
?>
  <title>EASYSHOP | Electrodomesticos</title>
  ...
  <section class="container-fluid mt-5">
      ...
      <input type="hidden" id="cliente" name="cliente" value="<?php if (isset($_SESSION['sesionIniciada'])) {
        ...
        <h5>La mejor calidad en Linea Blanca y los mejores productos de las mejores marcas</h5>
      </div>
      <div class="row">
        <!--  -->
          <?php
            ...
            try {
                $sql = "SELECT * FROM productos WHERE Categoria = 'Electrodomesticos'";
